    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Program Item Edit</h3>
            </div>
			<?php echo form_open('program_item/edit/'.$program_item['id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="program_id" class="form-control">
								...
								{
									$selected = ($program['id'] == $program_item['program_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="day" class="form-control">
								...
								{
									$selected = ($value == $program_item['day']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="meal" class="form-control">
								...
								{
									$selected = ($value == $program_item['meal']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="item_id" class="form-control">
								...
								{
									$selected = ($item['id'] == $program_item['item_id']) ? ' selected="selected"' : "";
