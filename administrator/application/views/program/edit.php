...
<div class="row" xmlns:v-on="http://www.w3.org/1999/xhtml" xmlns:v-bind="http://www.w3.org/1999/xhtml">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open_multipart('program/edit/'.$program['id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
                        <p id="programid" style="display: none;"><?php echo $program['id'] ?></p>
						<label for="title" class="control-label"><span class="text-danger">*</span>Title</label>
						<div class="form-group">
							<input type="text" name="title" value="<?php echo ($this->input->post('title') ? $this->input->post('title') : $program['title']); ?>" class="form-control" id="title" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="text" value="<?php echo ($this->input->post('text') ? $this->input->post('text') : $program['text']); ?>" class="form-control" id="text" />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="goal" name="goal" value="<?php echo ($this->input->post('goal') ? $this->input->post('goal') : $program['goal']); ?>"
                    ...
                    <div class="col-md-6">
                        <label for="female_calories" class="control-label">Female Calories</label>
                        <div class="form-group">
                            <input type="text" name="female_calories"
                                   value="<?php echo ($this->input->post('female_calories') ? $this->input->post('female_calories') : $program['female_calories']); ?>" class="form-control"
                                   id="female_calories"/>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="male_calories" name="male_calories"
                                   value="<?php echo ($this->input->post('male_calories') ? $this->input->post('male_calories') : $program['male_calories']); ?>" class="form-control"
                                   id="male_calories"/>
                    ...
                    <div class="btn btn-default image-preview-input">
                        ...
                        <img width="100" style="margin-top:5px;" src="<?php echo site_url('/uploads/'.$program['image']); ?>" alt="">
                    </div>
                    ...
                    <div class="col-md-6">
                       ...
                       <!-- /input-group image-preview [TO HERE]-->
                        <img width="50" style="margin-top:5px;" src="<?php echo site_url('/uploads/'.$program['icon']); ?>" alt="">
            ...
            <div class="box-body">
                ...
                <script>
                    ...
                    $(function () {
                        ...
                        $.ajax({
                            url: base_url + "Program/getProgramPricing",
                            method: 'GET',
                            data: {
                                "id": $('#programid').html()
                            },
                            ...
                            success: function (data) {
                                ...
                                var data_mp = new Array();

                                for (var j = 0; j < data.length; j++) {
                                    var obj = data[j];
                                    data_mp.push({text: obj.text , price: obj.price ,weeks: obj.weeks  });
                                }
                        ...
                        <div>
                            ...
                            <table class="table">
                                ...
                                <tr v-for="product in filteredProducts">
                                    ...
                                    <td>
<!--                                        {{ product.day }}-->
                                        <select disabled readonly v-model="product.day" class="form-control" id="edit-day">
                                    ...
                                    <td>
                                        ...
                                        <select disabled readonly v-model="product.meal" class="form-control" id="edit-meal">
                    ...
                    <script>
                        ...
                        var List = Vue.extend({
                            ...
                            mounted: function () {
                                ...
                                ;
                                $.ajax({
                                    url: base_url + "Program/getProgramItems",
                                    method: 'GET',
                                    data: {
                                        "id": $('#programid').html()
                                    },
                                    ...
                                    success: function (data) {
                                        ...
                                        $self.products = JSON.parse(data); //aaa
                                        loaded = true;

                                        for (var j = 0; j < $self.products.length; j++) {
                                            var obj = $self.products[j];
                                            products.push({
                                                id: obj.id,
                                                title: obj.title,
                                                day: obj.day,
                        ...
                        function initItemAutoComplete() {
                            $("#add-name").keyup(function () {
                                $.ajax({
                                    type: "POST",
                                    url: base_url + "Program/GetItemName",
                                    data: {
