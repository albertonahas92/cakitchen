            ...
            <div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input required type="text" name="title" value="<?php echo $this->input->post('title'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="sub_title" value="<?php echo $this->input->post('sub_title'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input  type="text" name="serving_size"
                                   value="<?php echo $this->input->post('serving_size'); ?>" class="form-control"
                                   id="serving_size"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="serving_per_container"
                                   value="<?php echo $this->input->post('serving_per_container'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="calories" value="<?php echo $this->input->post('calories'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="fat" value="<?php echo $this->input->post('fat'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="carbohydrates"
                                   value="<?php echo $this->input->post('carbohydrates'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="proteins" value="<?php echo $this->input->post('proteins'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="calories_from_fat"
                                   value="<?php echo $this->input->post('calories_from_fat'); ?>" class="form-control"
                                   id="calories_from_fat"/>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="sugars"
                                   value="<?php echo $this->input->post('sugars'); ?>" class="form-control"
                                   id="sugars"/>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            <select required name="cat_id" class="form-control">
                                ...
                                foreach ($all_categories as $cateogry) {
                                    $selected = ($cateogry['id'] == $this->input->post('cat_id')) ? ' selected="selected"' : "";
