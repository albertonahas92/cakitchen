    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Program Pricing Add</h3>
            </div>
            <?php echo form_open('program_pricing/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="weeks" value="<?php echo $this->input->post('weeks'); ?>" class="form-control" id="weeks" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="female_calories" value="<?php echo $this->input->post('female_calories'); ?>" class="form-control" id="female_calories" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="male_calories" value="<?php echo $this->input->post('male_calories'); ?>" class="form-control" id="male_calories" />
