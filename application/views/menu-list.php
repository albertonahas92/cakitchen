        ...
        <div class='food-tab wow fadeInUp'>
            <div class='container'>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#menu1" role="tab" data-toggle="tab">Full Menu</a></li>
                    <li role="presentation"><a href="#menu2" role="tab" data-toggle="tab">Calendar</a></li>
 ...
 <div  role="tabpanel" class="tab-pane fade in"  id="menu2">
  <section class="block menu-page-block">
            <div class="container">
                                ...
                                <div
                                        class="text-center menu-item-wrap">
                                           <h4><a href="#">Plat du jour</a></h4>
                                    <figure><a href="#"><img class="img-responsive"
                                                             src="<?php echo base_url('/') . "administrator/uploads/"; ?>{{ platdujour.image }}"
                                                             alt="Menu image"></a></figure>

                                    <div class="content">
                                   
                                        <h4><a href="#">{{platdujour.title}}</a></h4>
                                        <span>{{platdujour.sub_title}}</span>

                                        <h4 class="price"> {{platdujour.price}} LBP</h4>
                                        <div class="bottom">
                                            <div class="facts-table">
                                                <table>
                                                    <tbody>
                                                    <tr>
                                                        <td><span>Calories</span></td>
                                                        <td><span>{{platdujour.calories}}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><span>Proteins</span></td>
                                                        <td><span>{{platdujour.proteins}}g</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><span>Fats</span></td>
                                                        <td><span>{{platdujour.fat}}g</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><span>Carbohydrates</span></td>
                                                        <td><span>{{platdujour.carbohydrates}}g</span></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
