...
<main ng-controller="PlanController">
    <!-- =============== choose your own plan title block starts ================== -->
    <section class="choose-plan-block">
        <div class="container">
            <h5 class="text-center wow fadeInUp text-uppercase">Users</h5>
        </div>
    </section>
    <br>
    <section class="plan-step">
        <div class="steps-wrapper" data-wizard-init>
            ...
            <div style="background-color: #fff;padding:1em;" class="step-content">
...
<?php echo form_open('', array('role'=>'form')); ?>
    ...
    <div class="row">
        ...
        <div class="form-group col-sm-6<?php echo form_error('phone') ? ' has-error' : ''; ?>">
            ...
            <span class="required">*</span>
            <?php echo form_input(array('name'=> 'phone', 'value'=>set_value('phone', (isset($user['phone']) ? $user['phone'] : '')), 'class'=>'form-control', 'type'=>'tel')); ?>
        </div>
    </div>
