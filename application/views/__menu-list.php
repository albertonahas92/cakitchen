          ...
          $.ajax({
              ...
              success: function (data) {
                  ...
                  for (var j = 0; j < data.length; j++) {
                      ...
                      var item ='<div class="col-xs-12 col-sm-12 menu-item wow fadeInLeft"><div class="menu-item-wrap"><figure><a href="#"><img class="img-responsive" src="'+base_url+obj.image+' " alt="Menu image"></a></figure> <div class="mid"> <h4><a href="#">'+obj.title+'</a></h4> <span>'+obj.sub_title+'</span> <div class="facts-table"> <table> <tbody> <tr> <td><span>Calories</span></td> <td><span>'+obj.calories+'</span></td> </tr> <tr> <td><span>Proteins</span></td> <td><span>'+obj.proteins+'</span></td> </tr> <tr> <td><span>Fats</span></td> <td><span>'+obj.fat+'</span></td> </tr> <tr> <td><span>Carbohydrates</span>  </td> <td><span>'+obj.carbohydrates+'</span></td> </tr> </tbody> </table> </div> </div> <div class="right"> <h3 class="price">'+obj.price+'</h3> <a href="#" class="btn border-btn-small hvr-wobble-top" data-toggle="modal" data-target="#myModal">ADD TO CART</a> </div> </div> </div>';

                        $('.menu-listing-wrap').append(item);
