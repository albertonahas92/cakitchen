        ...
        $this
            ->add_external_css(
                array(
                    ...
                    base_url("/{$this->settings->themes_folder}/default/css/bootstrap.min.css"),
                    base_url("/{$this->settings->themes_folder}/default/css/font-awesome.css"),
                    base_url("/{$this->settings->themes_folder}/default/css/animate.css"),


                    base_url("/{$this->settings->themes_folder}/default/css/hover.css"),
                    base_url("/{$this->settings->themes_folder}/default/css/jquery.bxslider.css"),
                    base_url("/{$this->settings->themes_folder}/default/css/owl.carousel.css"),

                    base_url("/{$this->settings->themes_folder}/default/css/owl.transitions.css"),
                    base_url("/{$this->settings->themes_folder}/default/css/feature-carousel.css"),
                    base_url("/{$this->settings->themes_folder}/default/css/jquery-ui-1.9.2.custom.css"),
                    base_url("/{$this->settings->themes_folder}/default/css/style.css")
            ...
            ->add_external_js(
                array(
                    ...
                    base_url("/{$this->settings->themes_folder}/default/js/jquery-3.1.1.min.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/bootstrap.min.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/jquery-ui-1.9.2.custom.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/wow.min.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/Headroom.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/jquery.parallax-1.1.3.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/jquery.featureCarousel.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/jquery.bxslider.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/owl.carousel.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/jquery.waypoints.js"),

                    base_url("/{$this->settings->themes_folder}/default/js/jquery.counterup.js"),

                    base_url("/{$this->settings->themes_folder}/default/js/main.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/angular.min.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/angular-animate.js"),
                    base_url("/{$this->settings->themes_folder}/default/js/dirPagination.js"),

                    base_url("/{$this->settings->themes_folder}/default/js/script.js")
